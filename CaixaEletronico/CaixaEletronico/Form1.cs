...
namespace CaixaEletronico
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                bool saqueRealizado = contaSelecionada.Saca(valorSaque);
                if (saqueRealizado) MessageBox.Show("Saque realizado com sucesso");
            }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            cliente1.rg = "2.801.277";

            Cliente cliente2 = new Cliente();
            cliente2.rg = "2.801.277";
        ...
        {
            TesteWindowsForm teste = new TesteWindowsForm();
            teste.ShowDialog();
        }

        private void button9_Click(object sender, EventArgs e)
        {
            CadastroDeContas teste = new CadastroDeContas();
            teste.ShowDialog();
        }
    }
}